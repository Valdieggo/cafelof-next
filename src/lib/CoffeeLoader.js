export default function CoffeeLoader() {
  return (
    <div className="fixed inset-0 flex justify-center items-center w-screen h-screen z-[999] bg-black/20 backdrop-blur-sm">
      <svg
        width="100"
        height="100"
      ...
      >
        <defs>
          <linearGradient id="coffeeFill" x1="0" x2="0" y1="1" y2="0">
